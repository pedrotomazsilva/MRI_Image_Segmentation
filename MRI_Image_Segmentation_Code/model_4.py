...
from keras.layers import Input, concatenate, SeparableConv2D, MaxPooling2D, Conv2DTranspose, SpatialDropout2D, BatchNormalization
...
#spatial_dropout na quarta e quinta camadas para reduzir o nível de overfit
#otimizador - Adam
...
def unet(vis):
    ...
    up8_1 = BatchNormalization()(up8_1)
    ...
    up9_1 = BatchNormalization()(up9_1)
    ...
    conv9_3 = BatchNormalization()(conv9_3)
