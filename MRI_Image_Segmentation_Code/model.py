...
def unet(vis):
    ...
    conv5_1 = Conv2D(1024, (3,3), padding = 'same', activation = 'relu', 
                   kernel_initializer='he_normal')(pool4)
    conv5_2 = Conv2D(1024, (3,3), padding = 'same', activation = 'relu', 
    ...
    conv6_1 = Conv2D(512, (3,3), padding = 'same', activation = 'relu', 
                   kernel_initializer='he_normal')(up6_2)
    conv6_2 = Conv2D(512, (3,3), padding = 'same', activation = 'relu', 
    ...
    conv7_1 = Conv2D(256, (3,3), padding = 'same', activation = 'relu', 
                   kernel_initializer='he_normal')(up7_2)
    conv7_2 = Conv2D(256, (3,3), padding = 'same', activation = 'relu', 
    ...
    conv8_1 = Conv2D(128, (3,3), padding = 'same', activation = 'relu', 
                   kernel_initializer='he_normal')(up8_2)
    conv8_2 = Conv2D(128, (3,3), padding = 'same', activation = 'relu', 
    ...
    conv9_1 = Conv2D(64, (3,3), padding = 'same', activation = 'relu', 
                   kernel_initializer='he_normal')(up9_2)
    conv9_2 = Conv2D(64, (3,3), padding = 'same', activation = 'relu', 
                   kernel_initializer='he_normal')(conv9_1)
    conv9_3 = Conv2D(2, 3, activation = 'relu', padding = 'same', 
